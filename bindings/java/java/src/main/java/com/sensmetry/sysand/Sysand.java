...
public class Sysand {
  ...
  /**
   * Initialize a new project in the specified directory. The directory must already exist.
   *
   * @param name The name of the project.
   * @param version The version of the project in SemVer 2.0.0 format.
   * @param license The license of the project given as an SPDX license identifier. May be {@code
   *     null}.
  ...
  /**
   * Get the value of the constant {@code DEFAULT_ENV_NAME}, which is the default name of the
   ...
   * @param relativeFileRoot The path which should be used as the root for relative file URIs.
   * @return The project information and metadata.
   */
  public static native com.sensmetry.sysand.model.InterchangeProject[] info(
      String uri, String relativeFileRoot, String indexUrl)
      throws com.sensmetry.sysand.exceptions.SysandException;
  ...
  public static com.sensmetry.sysand.model.InterchangeProject[] info(
      java.net.URI uri, java.nio.file.Path relativeFileRoot, java.net.URL indexUrl)
      throws com.sensmetry.sysand.exceptions.SysandException {
   ...
   */
  public static com.sensmetry.sysand.model.InterchangeProject[] info(
      java.net.URI uri, java.nio.file.Path relativeFileRoot)
      throws com.sensmetry.sysand.exceptions.SysandException {
    return info(uri, relativeFileRoot, null);
  }

  /**
   * Get the project information and metadata at the given URI. Uses the current directory as the
   * relative file root.
   *
   * @param uri The URI of the project.
   * @return The project information and metadata.
  ...
  /**
   * Build Model Project Interchange file (.kpar) from the project at the given path.
   *
  ...
  /**
   * Build Model Project Interchange file (.kpar) from the workspace at the given path.
   *
   * @param outputPath The path to the output file.
