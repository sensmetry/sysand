...
public class BasicTest {
    ...
    public void testUpdateProjectIndex() {
        try {
            ...
            com.sensmetry.sysand.Sysand.updateProjectIndex(tempDir, index);
    ...
    @Test
    public void testUpdateWorkspaceProjectIndexes() {
        try {
            ...
            java.util.Arrays.sort(paths);
            com.sensmetry.sysand.Sysand.updateProjectIndex(java.nio.file.Paths.get(paths[0]), indexA);
            com.sensmetry.sysand.Sysand.updateProjectIndex(java.nio.file.Paths.get(paths[1]), indexB);
