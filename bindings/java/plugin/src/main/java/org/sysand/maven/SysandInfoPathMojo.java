 ...
 */
@Mojo(name = "info-path", defaultPhase = LifecyclePhase.PACKAGE, threadSafe = true)
public class SysandInfoPathMojo extends AbstractMojo {

    /**
     * Path passed to {@code Sysand.info_path}. Can be configured as
     * {@code <configuration><infoPath>...</infoPath></configuration>} or via
     * {@code -Dsysand.infoPath=...}.
     */
    ...
    public void execute() throws MojoExecutionException {
        ...
        try {
            ...
            org.sysand.Sysand.info_path(infoPath);
