    ...
    public void execute() throws MojoExecutionException {
        ...
        try {
            if (workspacePath == null) {
                ...
                com.sensmetry.sysand.Sysand.buildProject(Paths.get(outputPath), Paths.get(projectPath), compression, buildTag);
                ...
                com.sensmetry.sysand.Sysand.buildWorkspace(Paths.get(outputPath), Paths.get(workspacePath), compression, buildTag);
