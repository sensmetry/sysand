...
both the second one loses -- and for an embedder whose `sysand` subcommand is
reached through Python, the bridge is always first, because importing this
module is how the CLI is reached at all.
